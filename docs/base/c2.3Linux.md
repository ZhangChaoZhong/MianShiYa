...
top #查看所有进程的CPU运行情况，记录最大CPU使用率的进程id
top -Hp 5228	#查看进程的运行信息：查找到CPU占用最大的2个线程id
...
ps -ef | grep **flask** | grep -v grep | awk '{print $2}' | xargs kill -9![image-20210904152253686](JAVA/%E5%88%B7%E9%A2%98%E7%AC%94%E8%AE%B0/image-20210904152253686.png)
